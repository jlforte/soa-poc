...
public class POCTest2 implements POCTest2MBean
{

	private static Logger log = Logger.getLogger(POCTest2.class);

	public void deliver() throws Exception
	{
		log.info("POCTest2.deliver: entry");
...
//		Thread.sleep(2000); // wait 2 seconds
		...
		log.info("POCTest2.deliver message 2: scoreType=" + SOAPUtils.getValueOfAttributeInMessage(esbMessage, SOAPUtils.SCORE_TYPE_ATTR_NAME) + 
				 " messageID="  + SOAPUtils.getValueOfAttributeInMessage(esbMessage, SOAPUtils.MESSAGE_ID_ATTR_NAME) + 
				 " service category=" + SOAPUtils.SERVICE_CATAEGORY_CREDIT + 
				 " name=" + SOAPUtils.SERVICE_NAME_PROCESS_CREDIT_REQUESTS);
		log.debug("POCTest2.deliver message 2: message: " + SOAPUtils.messageToString(esbMessage));

		invoker = new ServiceInvoker(SOAPUtils.SERVICE_CATAEGORY_CREDIT, SOAPUtils.SERVICE_NAME_PROCESS_CREDIT_REQUESTS);
		invoker.deliverAsync(esbMessage);

		log.info("POCTest2.deliver: return");
